         ...
         <section class="projects-section bg-light" id="projects">
		  ...
		  <script type="text/javascript">
		     function checkform() {
		         ...
		         } else if (! (document.fr.writer.value.length >= 2 && document.fr.writer.value.length <= 10)) {
		            alert("작성자는 2~10자 내외로 입력해주세요");
		            document.fr.writer.value = "";
		            document.fr.writer.select();
		         }
		      }
		     </script>
		  <section class="content container-fluid">
				<div class="box-header">
					<h3 class="box-title">Q&A 글수정</h3>
				</div>
				...
				<form role="form" method="post">
					<div class="box-body">
						<div class="form-group">
							<label>제목</label> 
							<input type="text" name='title' class="form-control" value="${questionDTO.title }" required>
						</div>
						<div class="form-group">
							<label>내용</label>
							<input class="form-control" name="content" style="height:300px; " value="${questionDTO.title }" required></input>
						</div>
