                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">${library.name } 도서관 정보 수정</h1>
                            </div>
                            <form class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            id="name" placeholder="도서관 이름" value="${library.name }">
                                    </div>
                                	<div class="col-sm-6 mb-3 mb-sm-0">
                                		<input type="hidden" id="library_code" value=${library.library_code }>
                                	 </div>	
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="address"
                                        placeholder="도서관 주소" value="${library.address }">
                                </div>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="adminLibraryListOne?library_code=${library.library_code}">${library.name } 도서관 상세 정보로 돌아가기</a>
                            </div>
                        </div>
                    </div>
                </div>
...
function goPost() {
    ...
    let url = contextPath + "adminLibraryUpdate";
    ...
    let library_codeValue = document.getElementById("library_code").value; // 주소 입력 필드의 값 가져오기
