    ...
    <div id="wrapper">
       ...
       <%@include file="../include/manager/header.jsp"  %>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">블랙리스트 구제 신청 정보 상세 보기</h1>
                    <p class="mb-4">
                    	${blacklist.userid }님 블랙리스트 구제 신청 세부 사항
                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">회원 아이디</h6>
                                </div>
                                <div class="card-body">
                                   ${blacklist.userid }
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">회원 이메일</h6>
                                </div>
                                <div class="card-body">
                                     ${blacklist.useremail }
                                </div>
                        ...
                        <div class="button-container">
						    ...
						    <a href="javascript:void(0)" class="btn btn-primary btn-icon-split"
						        ...
						        <span class="text">블랙리스트 구제 신청 수락</span>
						    </a>
						    ...
						    <a href="javascript:void(0)" class="btn btn-danger btn-icon-split"
						        ...
						        <span class="text">블랙리스트 구제 신청 거절</span>
                                </a>
						</div>
...
function goPostYes() {
    ...
    let url = contextPath + "/librarianBlacklistOk";
    
    let save_codeValue = "${blacklist.save_code }"; // 주소 입력 필드의 값 가져오기
...
function goPostNo() {
    let contextPath = sessionStorage.getItem("contextpath");
    let url = contextPath + "/librarianBlacklistNo";
