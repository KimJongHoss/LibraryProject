    ...
    <div id="wrapper">
       ...
       <%@include file="../include/manager/header.jsp"  %>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">공지사항 수정</h1>
                    <p class="mb-4">
                    	공지사항 수정!
                    </p>
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                	<input type="text" name="writer" id="writer" readonly="readonly" value="${notice.writer }"
                                	style="width: 430px;">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <textarea name="content" rows="10" cols="47">${notice.content }</textarea>
...
function goPost() {
    ...
    let url = contextPath + "/librarianNoticeUpdate";
    
    let notice_numValue = ${notice.notice_num }; // 질문 번호 입력 필드의 값 가져오기
    ...
    let contentValue = document.querySelector('textarea[name="content"]').value; // textarea의 내용 가져오기
...
//  notice_num 데이터를 포함하는 hidden input 추가
    ...
    //  title 데이터를 포함하는 hidden input 추가
