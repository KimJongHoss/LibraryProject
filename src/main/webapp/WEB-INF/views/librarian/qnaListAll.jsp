                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Q&A 게시판 목록</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
									    ...
									    <tr>
									        <th>${question.question_num} </th>
									        <th><a href="librarianQnaListOne?question_num=${question.question_num}">${question.title}</a> </th>
									        <th>${question.writer}</th>
									        <th>${question.regdate} </th>
									        <th><span class="">${question.count}</span> </th>
									    </tr>
										</c:forEach>
                                    </tbody>
                                </table>
