...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       <%@include file="../include/manager/header.jsp"  %>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                   ...
                                   <tbody>
									    ...
									    <tr>
									        ...
									        <th><a href="${contextPath }/librarian/bookdetail?isbncode=${librarian.isbncode }&library_code=${librarian.library_code}&page=${page}">
            ...
            <c:if test="${prev }">
               <span>
                  [ <a href="${contextPath }/librarian/booklist?page=${startNum -1 }">이전</a> ]
               </span>
            </c:if>
            
            <c:forEach var="num" begin="${startNum }" end="${endNum }">
               <span>
                  <a href="${contextPath }/librarian/booklist?page=${num }" > ${num }</a>
               </span>
            </c:forEach>
            
            <c:if test="${next }">
               <span>
                  [ <a href="${contextPath }/librarian/booklist?page=${endNum + 1}" class="next">다음</a> ]
               </span>
            </c:if>
                        </div>
                    </div>
