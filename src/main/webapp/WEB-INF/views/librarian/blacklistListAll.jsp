                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">블랙리스트 구제 신청 목록</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
									    ...
									    <tr>
									        <th><a href="librarianBlacklistListOne?save_code=${blacklist.save_code}">${blacklist.save_code}</a></th>
									        <th>${blacklist.reason}</th>
									        <th>${blacklist.write_date}</th>
									        <th>${blacklist.userid}</th>
									        <th>${blacklist.useremail}</th>
									        <th>${blacklist.etc}</th>
									    </tr>
										</c:forEach>
                                    </tbody>
