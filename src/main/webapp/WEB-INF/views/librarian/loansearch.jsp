...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       <%@include file="../include/manager/header.jsp"  %>
                ...
                <div class="col-md-10 col-lg-8 mx-auto text-center">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">대출 목록</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="librarian" items="${search}">
									    <tr>
									        ...
									        ${librarian.loan_detail_num}</a></td>	
									         <!-- 도서 반납 버튼 -->
					                        <td><button class="btn btn-primary" onclick="location.href='${contextPath }/librarian/return?loan_detail_num=${librarian.loan_detail_num }&isbncode=${librarian.isbncode}&library_code=${librarian.library_code }&page=${page } '">도서 반납</button></td>                          
									    </tr>     								           
            ...
            <c:if test="${prev }">
               <span>
                  [ <a href="${contextPath }/librarian/loanSearch?page=${startNum -1 }">이전</a> ]
               </span>
            </c:if>
            
            <c:forEach var="num" begin="${startNum }" end="${endNum }">
               <span>
                  <a href="${contextPath }/librarian/loanSearch?page=${num }" > ${num }</a>
               </span>
            </c:forEach>
            
            <c:if test="${next }">
               <span>
                  [ <a href="${contextPath }/librarian/loanSearch?page=${endNum + 1}" class="next">다음</a> ]
               </span>
            </c:if>
                        </div>
                    </div>
