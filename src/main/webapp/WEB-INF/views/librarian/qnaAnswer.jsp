    ...
    <div id="wrapper">
       ...
       <%@include file="../include/manager/header.jsp"  %>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Q&A 질문 답변 폼 보기</h1>
                    <p class="mb-4">
                    	${question.writer }님 질문에 답변하기
                    </p>
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <input type="text" readonly="readonly" value="${question.title }에 대한 답변"
                                    style="width: 430px;">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">답변내용</h6>
                                </div>
                                <div class="card-body">
                                    <textarea name="content" rows="10" cols="47">질문 내용 : ${question.content }</textarea>
