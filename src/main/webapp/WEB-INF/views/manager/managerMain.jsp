       ...
       <%@include file="../include/manager/header.jsp"  %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						%>
						    <h1 class="h3 mb-0 text-gray-800">반갑습니다! <%=session.getAttribute("username") %>님</h1>
						<%
						}
						%>
                        <%
						...
						%>
						    <h1 class="h3 mb-0 text-gray-800">반갑습니다! <%=session.getAttribute("name") %>님</h1>
						<%
						}
						%>
                        <a href="/" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> 메인 홈페이지</a>
                    </div>
